...
;
; -u swaps the TCP half for UDPOPEN / SEND / RECV against a datagram echo
; responder (tools/dev/udp_echo.py).  It REPLACES the TCP exercise rather
; than following it: the v1 ABI has a single channel, and UDPOPEN requires
; it closed.  Two runs cover both transports.
;
...
;   default  : "<exe_home>\UNETRTL.DLL" via DSS APPINFO; on any APPINFO

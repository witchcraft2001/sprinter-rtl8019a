...
DEC_BUF		EQU APP_BSS_BASE + 40		; 4 bytes scratch for PRINT_DEC_A
...
SERVER_PORT_HI	 EQU APP_BSS_BASE + 18		; 1 byte
SERVER_PORT_LO	 EQU APP_BSS_BASE + 19		; 1 byte
EXPECTED_BLOCK	 EQU APP_BSS_BASE + 20		; 2 bytes
DATA_LEN	 EQU APP_BSS_BASE + 22		; 2 bytes
TOTAL_BYTES	 EQU APP_BSS_BASE + 24		; 2 bytes
RRQ_LEN		 EQU APP_BSS_BASE + 26		; 2 bytes
IP_TOTAL_LEN	 EQU APP_BSS_BASE + 28		; 2 bytes
UDP_LEN		 EQU APP_BSS_BASE + 30		; 2 bytes
OUT_FH		 EQU APP_BSS_BASE + 32		; 1 byte (set to NO_HANDLE at startup)
TFTP_PAYLOAD_PTR EQU APP_BSS_BASE + 34		; 2 bytes
TFTP_PAYLOAD_LEN EQU APP_BSS_BASE + 36		; 2 bytes
TFTP_DST_PORT_HI EQU APP_BSS_BASE + 38		; 1 byte
TFTP_DST_PORT_LO EQU APP_BSS_BASE + 39		; 1 byte
